...
public class ByIdGetTagNameGetAttributeTest extends GoldfishDatastarAbstractChromeWebDriverTestNgTest {
	...
	public void testTitle() {
		...
		// assert the title
		assertEquals("First Web Application", driver.getTitle());// First Web Application
